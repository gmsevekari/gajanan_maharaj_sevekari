...
void main() {
        ...
        onGenerateRoute: (settings) {
          ...
          if (settings.name == Routes.adminGajananMaharajGroups) {
            ...
            if (args is AdminUser) {
              return MaterialPageRoute(
                builder: (context) =>
                    AdminGajananMaharajGroupScreen(adminUser: args),
              );
            }
          }
          return MaterialPageRoute(
            builder: (context) => Scaffold(body: Text('Fallback')),
          );
        },
  ...
  testWidgets('adminGajananMaharajGroups route handles Map arguments', (
    tester,
  ) async {
        ...
        child: MaterialApp(
          ...
          onGenerateRoute: (settings) {
            ...
            if (settings.name == Routes.adminGajananMaharajGroups) {
              ...
              if (args is AdminUser) {
                return MaterialPageRoute(
                  builder: (context) => const Text('Old Logic'),
                );
              }
              // It should fail to find 'mode' if we use the old logic
              return MaterialPageRoute(
                builder: (context) => const Text('New Logic'),
              );
            }
