...
Always apply following coding guidelines:
...
- **Format Only Modified Files:** Run `dart format` only on the specific files you modified (e.g., `dart format lib/path/to/file.dart`). Never run `dart format .` globally.
