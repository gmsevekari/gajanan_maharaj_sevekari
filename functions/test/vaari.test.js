...
describe("Vaari Cloud Functions", () => {
  let myFunctions;
  let firestoreMock;
  ...
  describe("updateVaariStatuses", () => {
    ...
    beforeEach(() => {
      ...
      firestoreMock.collection.withArgs("vaari_events").returns({
    ...
    it("should transition enrolling to ongoing if start time is reached",
        async () => {
          ...
          const wrapped = test.wrap(myFunctions.updateVaariStatuses);
          await wrapped({});
