...
def format_verse(text):
    """
    Formats a Marathi verse by splitting it into two lines
    after the second danda (।).
    """
    # Find the first danda
    first_danda_index = text.find('।')
    
    # Find the second danda (start searching after the first one)
    second_danda_index = text.find('।', first_danda_index + 1)
    
    # Check if we actually found two dandas
    if first_danda_index != -1 and second_danda_index != -1:
        # Split the text immediately after the second danda
        # (+1 includes the danda itself in the first line)
        split_index = second_danda_index + 1
    ...
    # If the format doesn't match (e.g., only 1 danda), return original text
    return text
...
# 1. SAMPLE DATA (Copy-paste your raw lines here)
raw_verses = [
...
"तूं पोर्‍या तरणा ज्वान । नाहीं कशाची तुला वाण । ऐसें साच असोन । चिंतातुर दिसतोसी ॥१३॥",
...
"लौकिक यांचा वर्‍हाडांत । होता मोठया प्रमाणांत । ते आले फिरत फिरत । कीर्तन कराया शेगांवीं ॥२३॥",
...
"इतुकें असून तें पाणी । खराब केलें गुरुंनीं । तेवीं जाणार्‍या येणार्‍यांनीं । नाहीं पिण्याच्या योग्य तें ॥३५॥",
...
"खडकु दुदंडी व्याघ्रांबरी । हीं मुसलमानी नाणीं सारीं । चालत होतीं व्यवहारीं । तया वर्‍हाड प्रांतांत ॥४८॥",
...
"भागवताचा श्लोक सांगसी । आणि त्याच्या विरुद्ध वागसी । कथेकर्‍याची रीत ऐसी । बरवी नव्हे गोविंदा ॥६६॥",
"पोटभर्‍या कथकेरी । तूं न व्हावें भूमीवरी । जा कीर्तन समाप्त करी । मी येथून ऐकतों ॥६७॥",
"बुवा कीर्तनीं परत आले । गर्जोन अवघ्यां बोलले । तुमच्या शेगांवीं अमोल आलें । रत्‍न हें त्या सांभाळा ॥६८॥",
...
"पुढें माणिक चौकांत । चौथे दिवशीं सद्‌गुरुनाथ । भेटले बंकटलाला प्रत । अस्तमानाचे समयाला ॥७६॥",
...
"विचार केला अखेरीं । दुपारच्या पुर्‍या आहेत घरीं । त्याच ठेवोन तबकांतरीं । पुढें ठेवूं समर्थांच्या ॥८८॥",
...
"पुर्‍या बदाम खारका । केळीं मोसंबीं मुळे देखा । भालाप्रती लाविला बुका । कंठीं घातिला पुष्पहार ॥९२॥",
...
"खा हें आतां अवघें अन्न । अघोर्‍या न करी अनमान । पाहों आले अवघे जन । तुझ्या अघोर वृत्तीला ॥१९॥",
...
"उलटीं होतां परत । ती भक्षूं लागले सद्‌गुरुनाथ । श्रीरामदासस्वामी समर्थ । वासनेसी जिंकावया ॥२४॥",
"तैसें लोकाग्रहाला । घालावयासी शीघ्र आळा । हा उलटीचा प्रकार केला । अंगीं बळ असूनिया ॥२५॥",
"सत्‌पुरुषाचें आचरण । पुढील पिढीला साधन । होतें कराया संरक्षण । निसर्गाच्या धर्माचें ॥२६॥",
...
if not os.path.exists(input_filename):
    ...
    print("Please create 'input.txt' and paste your verses inside it.")
else:
...
with open(input_filename, "r", encoding="utf-8") as infile, \
        ...
        for line in lines:
            ...
            # Format the verse
            formatted_text = format_verse(line.strip())
