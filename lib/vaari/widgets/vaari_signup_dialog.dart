...
class VaariSignupDialog extends StatefulWidget {
  final VaariEvent event;
  final bool isEdit;
  final String? prefilledJoinCode;

  const VaariSignupDialog({
    super.key,
    required this.event,
    this.isEdit = false,
  ...
  @override
  State<VaariSignupDialog> createState() => _VaariSignupDialogState();
}

class _VaariSignupDialogState extends State<VaariSignupDialog> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();
  final _countryCodeController = TextEditingController(
    text: GroupConstants.defaultCountryCode,
  );
  ...
  Future<void> _handleDelete() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(localizations.deleteSignupConfirmMessageVaari),
        actions: [
          TextButton(
